				...
				<table width="90%"  align="center" cellpadding="5" cellspacing="1" class="tablecss" >
					...
					<tr>
					  ...
					  <td width="690" valign="middle">
					  	...
					  	<span class="gray tips">如：VIP影视解析系统</span>
					  </td>
					</tr>
					<tr>
					    ...
					    <td width="690" valign="middle">
					      ...
					      <span class="gray tips">网站域名，如 http://www.noome.cn </span>
					    </td>
					</tr>
					...
					<tr>						
					    ...
					    <td valign="top">请将解析接口分别填入下列空中<font color="red">（接口名称根据自己喜好修改）</font><div class="cl5"></div>
							...
							<input type="text" name="aik[jiexi10name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiexi10name']?>" size=20" ><input type="text" name="aik[jiexi10]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiexi10']?>" size="80" ><br/>
					    </td>
					</tr>										
					<tr>
